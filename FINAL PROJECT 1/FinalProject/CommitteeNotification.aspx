<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CommitteeNotification.aspx.cs" Inherits="FinalProject.CommitteeNotification" %>
    ...
    <form id="form1" runat="server">
        ...
        <div>
             <div class="topnav">
                ...
                <a href="CommitteeNotification.aspx"><asp:ImageButton ID="ImageButton1" runat="server" Width="25px"  /></a>
                <a><asp:Label ID="counter" runat="server" Text="0"></asp:Label></a>
             </div>
        </div>
        
        <center style="position:absolute;margin-top:100px;margin-left:500px;">
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" Width="400px" DataKeyNames="idPresc" DataSourceID="SqlDataSource1" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" CellPadding="4" ForeColor="#333333" GridLines="None">
