<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CommitteePrescForm.aspx.cs"  MaintainScrollPositionOnPostback="true" Inherits="FinalProject.CommitteePrescForm" %>
                      ...
                      <center>
                            <table >
                                ...
                                <tr>
                                 <td>
                                     ...
                                     <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" Width="400px" CellPadding="4" DataKeyNames="idPrescTest" DataSourceID="SqlDataSource1" ForeColor="#333333" GridLines="None">
                                         ...
                                         <Columns>
                                             ...
                                             <asp:BoundField DataField="Test" ItemStyle-HorizontalAlign="Center" HeaderText="Test" SortExpression="Test" ReadOnly="true"/>
                                     ...
                                     <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:DbCon %>" ProviderName="<%$ ConnectionStrings:DbCon.ProviderName %>" SelectCommand="SELECT * FROM [PrescTest] WHERE ([idPresc] = @idPresc)" UpdateCommand="update [PrescTest] set [TestReduction]=@TestReduction, [TestApprove]=@TestApprove where [idPrescTest]=@idPrescTest">
                                         <SelectParameters>
                                     ...
                                     <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" Width="400px" CellPadding="4" DataKeyNames="idPrescRadio" DataSourceID="SqlDataSource2" ForeColor="#333333" GridLines="None">
                                         <AlternatingRowStyle BackColor="White" />
                                         <Columns>
                                             ...
                                             <asp:BoundField DataField="idPresc" HeaderText="idPresc" SortExpression="idPresc" Visible="False" />
                                             <asp:BoundField DataField="Radio" ItemStyle-HorizontalAlign="Center" HeaderText="Radio" SortExpression="Radio" ReadOnly="true" />
                                     ...
                                     <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:DbCon %>" ProviderName="<%$ ConnectionStrings:DbCon.ProviderName %>" SelectCommand="SELECT * FROM [PrescRadio] WHERE ([idPresc] = @idPresc)"  UpdateCommand="update [PrescRadio] set [RadioReduction]=@RadioReduction, [RadioApprove]=@RadioApprove where [idPrescRadio]=@idPrescRadio">
                        ...
                        <table>
                              <tr>
                                  ...
                                  <td>
                                      <asp:Button ID="Button3" runat="server" Text="Send" style="margin-left:100px;font-size:larger;" CausesValidation="False" OnClick="Button3_Click1"/>
