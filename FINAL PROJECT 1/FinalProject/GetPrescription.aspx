<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GetPrescription.aspx.cs" Inherits="FinalProject.WebForm6" %>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <table>
                ...
                <tr>
                    <td colspan="3" style="position:absolute;margin-left:18%;"><asp:TextBox ID="TextBox6" runat="server" Height="22px" Width="284px" placeholder="PhoneNumber" ReadOnly="true" CssClass="auto-style16"></asp:TextBox></td>
                   <td class="auto-style18">
                        <asp:Label ID="Label26" runat="server" Text="رقم المريض" CssClass="auto-style19"></asp:Label></td>
                </tr>
            </table>
            <br />
                        ...
                        <table>
                              <tr>
                                  ...
                                  <td>
                                      ...
                                      <asp:CheckBox ID="CheckBox1" runat="server" style="margin-left:650px;font-size:large;" Enabled="false" Font-Bold="True" Text="موافقة" TextAlign="Left" Width="200px" Checked="True" />
