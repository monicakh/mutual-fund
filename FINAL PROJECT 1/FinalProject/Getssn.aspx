<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Getssn.aspx.cs" Inherits="FinalProject.GetPrescription" %>
        ...
        <div>
            ...
            <div>
             <center style="margin-top:200px;">
                ...
                <asp:Label ID="Label1" runat="server" Text=":رقم الضمان" style="font-weight:600;font-size:40px;margin-top:20px"></asp:Label>
