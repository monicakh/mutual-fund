<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HomeNotification.aspx.cs" Inherits="FinalProject.HomeNotification" %>
   ...
   <form id="form1" runat="server">
        ...
        <div>
             ...
             <div class="topnav">
                ...
                <a href="HomeNotification.aspx"><asp:ImageButton ID="ImageButton1" runat="server" Width="25px"  /></a>
                <a><asp:Label ID="counter" runat="server" Text="0"></asp:Label></a>
             </div>
        </div>
       
       
       <center style="position:absolute;margin-top:100px;margin-left:400px;">
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" width="600px" DataKeyNames="idPresc" DataSourceID="SqlDataSource1" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" CellPadding="4" ForeColor="#333333" GridLines="None">
            ...
            <Columns>
                ...
                <asp:BoundField DataField="receiptNB" HeaderText="receiptNB" SortExpression="receiptNB" />
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:DbCon %>" ProviderName="<%$ ConnectionStrings:DbCon.ProviderName %>" SelectCommand="SELECT * FROM [Prescription] WHERE (([ComNotification] = @ComNotification) AND ([ComSecNotification] = @ComSecNotification) AND ([LabNotification] = @LabNotification))">
            <SelectParameters>
                <asp:Parameter DefaultValue="True" Name="ComNotification" Type="Boolean" />
                <asp:Parameter DefaultValue="True" Name="ComSecNotification" Type="Boolean" />
